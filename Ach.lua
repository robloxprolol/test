...
game.Players.LocalPlayer.Character["MeshPartAccessory"].Name = "Nebula Blade"
game.Players.LocalPlayer.Character["Nebula Blade"].Handle.SpecialMesh:Remove()
wait (.1)
...
if game.Players.LocalPlayer.Character:FindFirstChild("Nebula Blade") then --Nebula Blade 
	...
	local HatChoice = game.Players.LocalPlayer.Character:FindFirstChild("Nebula Blade") --Nebula Blade 
	HatChoice.Handle:FindFirstChildOfClass("AlignPosition").Attachment1 = athp
	HatChoice.Handle:FindFirstChildOfClass("AlignOrientation").Attachment1 = atho
